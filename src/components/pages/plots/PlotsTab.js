...
import MultiPlots from './MultiPlots';



class PlotsTab extends Component {
    constructor(props) {
        super(props);
        this.state = {
            category: true,
    ...
    handleChild = (child) => {
        ...
        ApiGateWay.Get('/allMetricFiles?parentName=' + this.state.parentCategory + '&childName=' + child).then(res => res.json()).then(res => {
            console.log(res)
